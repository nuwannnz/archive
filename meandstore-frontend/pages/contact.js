...
export default function Contact() {
  return (
    <div className="bg-black  text-white">
      <NextSeo
        title="Contact: MeAndStore"
        description="Contact Us!"
        canonical="https://www.meandstore.com/contact"
        openGraph={{
          url: "https://www.meandstore.com/contact",
        }}
      />
      <Head>
        <title>Contact: MeAndStore</title>
        ...
        <div class="container px-5 pt-24 pb-16 mx-auto">
          ...
          <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
              ...
              <div class="p-2 w-full">
                {/* <button class="flex mx-auto border-0 py-2 px-8 rounded text-lg bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 text-black"> */}
                <button class="flex mx-auto border-0 py-2 px-8 rounded text-lg bg-indigo-600 text-black">
                  Send
                </button>
              </div>
              <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a class="text-indigo-500">contact@meandstore.com</a>
                <p class="leading-normal my-5">Colombo, Sri Lanka</p>
              </div>
            </div>
          </div>
        </div>
